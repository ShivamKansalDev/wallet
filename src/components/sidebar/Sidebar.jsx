    ...
    <>
      <div className="flex flex-col items-center h-full overflow-hidden text-gray-400 bg-white rounded fixed inset-y-0 left-0 z-10 w-14   border-r bg-background sm:flex">
        <div className="flex flex-col items-center mt-3">
          <Link
            className={`flex items-center justify-center w-8 h-8 mt-3 mb-3 rounded hover:bg-[#0841cf] hover:text-[#fff] ${
              pathname === "/dashboard/home"
                ? "w-8 h-8 bg-[#0841cf] text-[#fff]"
                : ""
            }`} 
            href="/dashboard/home"
          >
          ...
          <Link
            className={`flex items-center justify-center w-8 h-8 rounded mb-3 hover:bg-[#0841cf] hover:text-[#fff] ${
